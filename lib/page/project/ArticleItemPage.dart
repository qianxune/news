...
import 'package:flutter_eyepetizer/config/GlobalConfig.dart';
import 'package:flutter_eyepetizer/model/article_list/ArticleItemModel.dart';
import 'package:flutter_eyepetizer/util/StringUtil.dart';
import 'package:flutter_eyepetizer/widget/StrokeWidget.dart';
...
class ArticleItemPage extends StatelessWidget {
  ...
  Widget _buildListViewItem(ArticleItemModel item) {
    var widget = (null != item.envelopePic &&
            ...
            !item.envelopePic.endsWith(ApiService.DEFAULT_PROJECT_IMG)) //默认图片就不显示了
        ? Row(
